...
## Clock Signal
set_property -dict {PACKAGE_PIN R4 IOSTANDARD LVCMOS33} [get_ports ClkSys100MhzxCLK]
create_clock -period 10.000 -name sys_clk_pin -waveform {0.000 5.000} -add [get_ports ClkSys100MhzxCLK]
...
#set_property -dict {PACKAGE_PIN D22 IOSTANDARD LVCMOS12} [get_ports BtnDxSI]
...
## Switches
#set_property -dict {PACKAGE_PIN E22 IOSTANDARD LVCMOS12} [get_ports {SwitchxDI[0]}]
#set_property -dict {PACKAGE_PIN F21 IOSTANDARD LVCMOS12} [get_ports {SwitchxDI[1]}]
#set_property -dict {PACKAGE_PIN G21 IOSTANDARD LVCMOS12} [get_ports {SwitchxDI[2]}]
#set_property -dict {PACKAGE_PIN G22 IOSTANDARD LVCMOS12} [get_ports {SwitchxDI[3]}]
#set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS12} [get_ports {SwitchxDI[4]}]
#set_property -dict {PACKAGE_PIN J16 IOSTANDARD LVCMOS12} [get_ports {SwitchxDI[5]}]
#set_property -dict {PACKAGE_PIN K13 IOSTANDARD LVCMOS12} [get_ports {SwitchxDI[6]}]
#set_property -dict {PACKAGE_PIN M17 IOSTANDARD LVCMOS12} [get_ports {SwitchxDI[7]}]
...
## Pmod header JB
set_property -dict { PACKAGE_PIN V9    IOSTANDARD LVCMOS33 } [get_ports { MIC_nCS }]; #IO_L21P_T3_DQS_34 Sch=jb_p[1]
#set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { jb[1] }]; #IO_L21N_T3_DQS_34 Sch=jb_n[1]
set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33 } [get_ports { SDATA }]; #IO_L19P_T3_34 Sch=jb_p[2]
set_property -dict { PACKAGE_PIN W7    IOSTANDARD LVCMOS33 } [get_ports { MIC_SCLK }]; #IO_L19N_T3_VREF_34 Sch=jb_n[2]
...
## Pmod header JC 
set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33 } [get_ports { SC_MCLK }]; #IO_L18P_T2_34 Sch=jc_p[1]
set_property -dict { PACKAGE_PIN AA6   IOSTANDARD LVCMOS33 } [get_ports { SC_LRCK }]; #IO_L18N_T2_34 Sch=jc_n[1]
set_property -dict { PACKAGE_PIN AA8   IOSTANDARD LVCMOS33 } [get_ports { SC_SCLK }]; #IO_L22P_T3_34 Sch=jc_p[2]
set_property -dict { PACKAGE_PIN AB8   IOSTANDARD LVCMOS33 } [get_ports { SC_SDOUT }]; #IO_L22N_T3_34 Sch=jc_n[2]
